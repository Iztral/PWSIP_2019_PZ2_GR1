...
public class PopupListDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_popup_list_dialog, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new PopupAdapter(getArguments().getInt(ARG_ITEM_COUNT)));
    }
    ...
    public interface Listener {
        void onPopupClicked(int position);
    }
        ...
        ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            text.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onPopupClicked(getAdapterPosition());
                        dismiss();
                    }
                }
            });
    ...
    private class PopupAdapter extends RecyclerView.Adapter<ViewHolder> {

        private final int mItemCount;

        PopupAdapter(int itemCount) {
