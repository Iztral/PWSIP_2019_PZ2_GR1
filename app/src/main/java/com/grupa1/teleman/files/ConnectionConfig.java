...
public class ConnectionConfig implements Parcelable {
    ...
    public ConnectionConfig(String databaseAddress, String databasePort, String databasePassword, String databaseName, String databaseUsername) {
        this.database[0] = databaseAddress;
        this.database[1] = databasePort;
        this.database[2] = databasePassword;
        this.database[3] = databaseName;
    ...
    public ConnectionConfig(String[] data) {
        if (data != null) {
            database = data;
            valid = true;
        }
